...
namespace S2ObjectDefinitions.EHZ
{
	class Bridge : ObjectDefinition
	{
		...
		{
			byte[] artfile = ObjectHelper.OpenArtFile("../art/nemesis/GHZ bridge.bin", CompressionType.Nemesis);
			byte[] mapfile = System.IO.File.ReadAllBytes("../mappings/sprite/obj11_GHZ.bin");
