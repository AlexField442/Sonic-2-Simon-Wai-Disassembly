Mus_Invinc_Header:
	...
	smpsHeaderVoice     Mus_Invinc_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $0B

	smpsHeaderDAC       Mus_Invinc_DAC
	smpsHeaderFM        Mus_Invinc_FM1,	$F4, $13
	smpsHeaderFM        Mus_Invinc_FM2,	$F4, $13
	smpsHeaderFM        Mus_Invinc_FM3,	$F4, $13
	smpsHeaderFM        Mus_Invinc_FM4,	$F4, $0A
	smpsHeaderFM        Mus_Invinc_FM5,	$F4, $13
	smpsHeaderPSG       Mus_Invinc_PSG1,	$D0, $01, $00, fTone_09
	smpsHeaderPSG       Mus_Invinc_PSG2,	$D0, $03, $00, $00
	smpsHeaderPSG       Mus_Invinc_PSG3,	$00, $03, $00, fTone_04
...
Mus_Invinc_Loop08:
	dc.b	nA6, $0C, nD6
	smpsLoop            $00, $08, Mus_Invinc_Loop08
	smpsAlterVol        $FE
	smpsPan             panCenter, $00

Mus_Invinc_Loop09:
	smpsCall            Mus_Invinc_Call04
	smpsLoop            $00, $02, Mus_Invinc_Loop09

Mus_Invinc_Loop0A:
	smpsCall            Mus_Invinc_Call01
	dc.b	nRst, nF6, nRst, nE6, nRst, nF6, nG6, $12
	smpsCall            Mus_Invinc_Call01
	dc.b	nRst, nF6, $0C, nRst, $24
	smpsLoop            $00, $02, Mus_Invinc_Loop0A
	smpsCall            Mus_Invinc_Call02
	smpsJump            Mus_Invinc_FM1
...
Mus_Invinc_Loop06:
	smpsCall            Mus_Invinc_Call04
	smpsLoop            $00, $02, Mus_Invinc_Loop06
...
Mus_Invinc_Loop07:
	...
	smpsAlterPitch      $03
	smpsLoop            $00, $02, Mus_Invinc_Loop07
	smpsAlterPitch      $FA
	dc.b	nC6, $18, nRst, nE6, nRst, nG6, nG6, nG6, nG6
	smpsJump            Mus_Invinc_FM2
...
Mus_Invinc_Loop04:
	...
	smpsLoop            $00, $02, Mus_Invinc_Loop04
	smpsSetvoice        $00
...
Mus_Invinc_Loop05:
	...
	smpsAlterPitch      $04
	smpsLoop            $00, $02, Mus_Invinc_Loop05
	smpsAlterPitch      $F8
	dc.b	nA5, $18, nRst, nC6, nRst, nE6, nE6, nE6, nE6
	smpsJump            Mus_Invinc_Jump01
...
Mus_Invinc_Loop03:
	smpsCall            Mus_Invinc_Call03
	dc.b	nRst, $06, nE3, $0C
	smpsCall            Mus_Invinc_Call03
	dc.b	nF3, $06, nE3, $0C
	smpsLoop            $00, $02, Mus_Invinc_Loop03
	dc.b	nRst, $60
	smpsSetvoice        $01
...
Mus_Invinc_Loop02:
	...
	smpsLoop            $00, $02, Mus_Invinc_Loop02
	smpsSetvoice        $02
	smpsAlterNote       $02
	smpsCall            Mus_Invinc_Call02
	smpsAlterNote       $00
	smpsJump            Mus_Invinc_FM5
...
Mus_Invinc_PSG1:
	dc.b	nRst, $60
	smpsLoop            $00, $0A, Mus_Invinc_PSG1
...
Mus_Invinc_DAC:
	...
	smpsLoop            $00, $03, Mus_Invinc_DAC
	dc.b	dKick, $0C, dSnare, $06, dKick, $0C, dSnare, $06, $0C

Mus_Invinc_Loop00:
	dc.b	dKick, $0C, dSnare
	smpsLoop            $00, $07, Mus_Invinc_Loop00
	dc.b	dKick, $06, dSnare, dSnare, $0C
	smpsLoop            $01, $05, Mus_Invinc_Loop00
	smpsJump            Mus_Invinc_DAC
