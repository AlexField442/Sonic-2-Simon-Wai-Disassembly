Mus_SpecStg_Header:
	...
	smpsHeaderVoice     Mus_SpecStg_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $00

	smpsHeaderDAC       Mus_SpecStg_DAC
	smpsHeaderFM        Mus_SpecStg_FM1,	$0C, $0A
	smpsHeaderFM        Mus_SpecStg_FM2,	$00, $05
	smpsHeaderFM        Mus_SpecStg_FM3,	$00, $0E
	smpsHeaderFM        Mus_SpecStg_FM4,	$00, $0E
	smpsHeaderFM        Mus_SpecStg_FM5,	$00, $0F
	smpsHeaderPSG       Mus_SpecStg_PSG1,	$DC, $02, $00, fTone_0B
	smpsHeaderPSG       Mus_SpecStg_PSG2,	$DC, $04, $00, fTone_0B
	smpsHeaderPSG       Mus_SpecStg_PSG3,	$00, $01, $00, $00
...
Mus_SpecStg_Loop0C:
	...
	smpsLoop            $00, $07, Mus_SpecStg_Loop0C
	smpsJump            Mus_SpecStg_Loop0C
...
Mus_SpecStg_Loop0A:
	...
	smpsLoop            $00, $02, Mus_SpecStg_Loop0A
	smpsAlterVol        $FE
	smpsPan             panRight, $00
...
Mus_SpecStg_Loop0B:
	...
	dc.b	nAb4, $18, nRst
	smpsLoop            $00, $02, Mus_SpecStg_Loop0B
	smpsAlterVol        $02
	smpsJump            Mus_SpecStg_Loop0A
...
Mus_SpecStg_Loop07:
	...
	smpsLoop            $01, $02, Mus_SpecStg_Loop07
	smpsPan             panCenter, $00
	dc.b	nRst, $30, nRst, nRst, nRst, nAb4, $06, nRst, $0C, $06, nRst, $0C
	dc.b	nAb4, $06, nRst, nAb4, nRst, $0C, $06, nRst, $0C, nAb4, $06, nRst
	dc.b	nAb4, nRst, $0C, $06, nRst, $0C, nAb4, $06, nRst, nAb4, nRst, $2A
	smpsLoop            $00, $02, Mus_SpecStg_Loop08
	smpsPan             panLeft, $00
	smpsAlterNote       $FE
	smpsAlterVol        $F8
...
Mus_SpecStg_Loop09:
	...
	dc.b	nRst, nCs5, nE5, $12, nB4, $06, nRst, nB4, nRst, nCs5, nB4, $12
	dc.b	nAb4, $18, nRst
	smpsLoop            $00, $02, Mus_SpecStg_Loop09
	smpsAlterNote       $00
	smpsAlterVol        $08
	smpsJump            Mus_SpecStg_Loop08
...
Mus_SpecStg_Loop04:
	...
	smpsLoop            $01, $02, Mus_SpecStg_Loop04
	dc.b	nRst, $30, nRst, nRst, nRst, nE4, $06, nRst, $0C, $06, nRst, $0C
	dc.b	nE4, $06, nRst, nE4, nRst, $0C, $06, nRst, $0C, nE4, $06, nRst
	dc.b	nE4, nRst, $0C, $06, nRst, $0C, nE4, $06, nRst, nE4, nRst, $2A
	smpsLoop            $00, $02, Mus_SpecStg_Loop05
...
Mus_SpecStg_Loop06:
	...
	dc.b	nE4, $18, nRst
	smpsLoop            $00, $02, Mus_SpecStg_Loop06
	smpsJump            Mus_SpecStg_Loop05
...
Mus_SpecStg_Loop03:
	...
	smpsPan             panCenter, $00
	dc.b	nD5
	smpsLoop            $00, $1C, Mus_SpecStg_Loop03
	smpsJump            Mus_SpecStg_Loop03
...
Mus_SpecStg_Loop11:
	...
	dc.b	$30, nRst
	smpsLoop            $00, $02, Mus_SpecStg_Loop11
...
Mus_SpecStg_Loop00:
	...
	smpsLoop            $00, $03, Mus_SpecStg_Loop00
...
Mus_SpecStg_Loop01:
	...
	smpsLoop            $00, $04, Mus_SpecStg_Loop01
...
Mus_SpecStg_Loop02:
	...
	smpsLoop            $00, $02, Mus_SpecStg_Loop02
	smpsJump            Mus_SpecStg_Loop01
